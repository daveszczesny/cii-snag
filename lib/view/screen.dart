      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              GestureDetector(
                onTap: TierService.instance.canCreateProjectFromList(projects) ? () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("Free tier limited to a maximum of 2 projects.")
                    )
                  );
                } : null,
                child: IconButton(
                  ...
                  onPressed: TierService.instance.canCreateProjectFromList(projects) ? () {
                    Navigator.pop(context);
